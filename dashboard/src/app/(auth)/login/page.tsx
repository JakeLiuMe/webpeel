      ...
      <div className="flex w-full flex-col items-center justify-center overflow-y-auto px-4 sm:px-6 py-8 lg:w-1/2" style={{ backgroundColor: '#0A0A0F' }}>
        <div className="w-full max-w-[380px]">
            ...
            <>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-[15px] font-medium text-zinc-100 shadow-sm transition-all hover:bg-zinc-800 hover:border-zinc-600 active:scale-[0.99]"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <div className="mb-1.5 flex items-center justify-between">
                    ...
                    <Link href="/forgot-password" className="text-[12px] text-zinc-300 hover:text-zinc-100">
                      Forgot password?
                    </Link>
                  </div>
                  <input
          ...
          <p className="mt-4 text-center text-[11px] text-zinc-500 leading-relaxed">
            ...
            and agree to our{' '}
            <a href="https://webpeel.dev/terms" className="underline hover:text-zinc-300">Terms of Service</a>.
          </p>
        </div>
      </div>
