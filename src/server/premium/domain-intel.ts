...
const methodCounts = new Map<
  string,
  { simple: number; browser: number; stealth: number }
>();
...
function getDomainRecommendation(url: string): DomainRecommendation | null {
  ...
  if (intel.sampleCount < MIN_SAMPLES) return null;
...
export function createDomainIntelHooks(): Pick<
  StrategyHooks,
  'getDomainRecommendation' | 'recordDomainResult'
> {
  return {
